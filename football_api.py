...
# Kabul edilen ülkeler (whitelist)
ALLOWED_COUNTRIES = {
    # Avrupa - Büyük ligler
    "england","germany","spain","italy","france","netherlands",
    "portugal","belgium","turkey","russia","scotland","greece",
    "switzerland","austria","denmark","norway","sweden","poland",
    "czech republic","slovakia","romania","hungary","croatia",
    "serbia","ukraine","bulgaria","israel","cyprus","wales",
    "northern ireland","ireland","finland","iceland","luxembourg",
    "slovenia","bosnia and herzegovina","albania","montenegro",
    "north macedonia","georgia","armenia","azerbaijan","moldova",
    "kosovo","estonia","latvia","lithuania","belarus","kazakhstan",
    # Amerika
    "brazil","argentina","mexico","colombia","chile","uruguay",
    "peru","ecuador","venezuela","usa","canada",
    # Asya / Okyanusya
    "japan","south korea","korea republic","china","australia",
    "saudi arabia","united arab emirates","qatar","iran","iraq",
    # Afrika (büyükler)
    "south africa","egypt","morocco","nigeria","ghana","tunisia",
...
def _is_excluded(league_name, country_name):
    ...
    # Önce anahtar kelime filtresi
    if any(k in full for k in EXCLUDE_KW):
        return True

    # Sonra whitelist kontrolü - ülke listede değilse çıkar
    if cn and not any(c in cn for c in ALLOWED_COUNTRIES):
        return True

    # Avustralya sadece A-League Men
    if "australia" in cn and "a-league men" not in ln:
        return True
