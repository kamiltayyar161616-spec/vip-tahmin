...
teamId calismadigi icin tarih araliginda tum maclar cekilip takim filtrelenir
"""
import requests
import datetime
import time
...
# ─────────────────────────────────────────────
# TAKIM SON MACLARI
# teamId calismadigi icin tarih araliginda ara
# ─────────────────────────────────────────────
...
def _get_team_all_matches(team_id):
    ...
    Her hafta icin tarih araliginda arama yapar.
    """
    ...
    # Haftalk parcalar halinde cek (7 gunluk)
    current = season_start
    while current <= yesterday:
        chunk_end = min(current + datetime.timedelta(days=13), yesterday)
